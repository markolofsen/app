...
import {Image, List, FlatList, ListView, ActivityIndicator, TouchableOpacity, ScrollView} from 'react-native';
...
export default class CatalogPageContainer extends React.Component<Props, State> {
  constructor(props) {
    super(props);
    // this.fetchMore = _.debounce(this._fetchMore.bind(this), 500);
  ...
  _fetchMore() {
		...
		if(!this.state.isLoadingMore) {
			...
			console.log("SCROL "+this.state._dataPage)
		}
